...
public class NatacionCommand extends FrontCommand{
    ...
    public void process() {
        try {
            ...
            HashMap<String,String> horario = xmlreader.XMLreader("local","Natacion");
